...
//     final internetBloc = InternetBloc(connectivity: connectivity);

//     setUp(() {
//       counterBloc = CounterBloc(internetBloc: InternetBloc(connectivity: connectivity));
//     });
//     tearDown(() {
//       counterBloc?.close();
//     });
...
//     //   build: () => CounterBloc(internetBloc: internetBloc),
